...
is a educational module, its not intended to replace the excellent Python Image Library, in fact  it uses PIL.
...
"""
""" 
Note [Ernesto Costa: March 2013]:
This module was simplified to work without PIL.
"""
...
# Release Notes:
# This was changed by Ernesto Costa
# Inspired by John Zelle's graphics.py
# Version 1.0 - November 2009
# Changes:
# Introduce the possibility of changing the coordinates of the world...
# Change the print command. Now is again 2.X compatible!
...
# [EC] --- (New) Internal class to transform the 2D coordinates
...
class AbstractImage(object):
    ...
    # [EC]: modified to take into consideration changing the coordinates
    def draw(self,win):
        ...
        self.canvas=win
	x,y = win.toScreen(self.centerX,self.centerY) # introduced!
        self.id = self.canvas.create_image(x,y,image=ig)
        _imroot.update()
    # [EC]: end of modification
...
if __name__ == '__main__':
    win = ImageWin("A Minha Janela",762,1016)
    oImage = FileImage('/data/imagens/duck.jpg')
    oImage.draw(win)
    myImage = oImage.copy()
    ...
    myImage.save('/data/imagens/other_duck.jpg')
